...
seq_length = 20		# fixed length sliding window for training pattern
...
filepath="decreased-weights-improvement-{epoch:02d}-{loss:.4f}-bigger.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='loss', verbose=1, save_best_only=True, mode='min')
callbacks_list = [checkpoint]

#checkpoint_name = "decreased-weights-improvement-24-2.6747-bigger.hdf5"
