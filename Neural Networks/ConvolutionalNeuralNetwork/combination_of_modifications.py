...
# Add third 2D convolutional layer; this layer reads the subsampled feature map from the second convolutional layer
model.add(Conv2D(NUM_FILTERS, (FILTER_SIZE, FILTER_SIZE), activation = 'relu'))

# Add third subsampling layer, also using average pooling
model.add(AveragePooling2D(pool_size = (MAXPOOL_SIZE, MAXPOOL_SIZE)))
